...
(function(){
  ...
  var CJPCD = function (provinceId,cityId,districtId) {
    ...
    c.city_builder = function(){
      ...
      var pro_Id;
      //获取当前选中省份的索引
      pro_Id = c.province.options[c.province.selectedIndex].getAttribute("prov_index");
      city_obj = c.cj_areas_json[pro_Id].city;
      //创建子元素
    ...
    c.district_builder = function(){
      ...
      // console.log(c.city.selectedIndex)
      var city_Id;
      city_Id = c.city.options[c.city.selectedIndex].getAttribute("city_index");
